...
def main():
    ...
    for decade in intervalls:
        ...
        untersuchungsbereich = CorpusText._apply_stopwords([ ( (wordnet_lemmatizer.lemmatize(a.lower(), pos=get_wordnet_pos(b))) ,b) for (a,b) in corpora[0] ])
        kontrollbereich = CorpusText._apply_stopwords([ ( (wordnet_lemmatizer.lemmatize(a.lower(), pos=get_wordnet_pos(b))) ,b) for (a,b) in corpora[1] ])
        ...
        oanc_file = FileReader.read_ANC_file(anc_all_count, 1, 3, 2)
        ...
        for arg in args:
            ...
            #fredDist_anc = nltk.FreqDist(fredDist_anc)
            #print(oanc_freq_list[:500])
